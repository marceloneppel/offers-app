...
class ClassicIndicator extends Indicator {
  ...
  const ClassicIndicator({
    ...
    this.releaseText: 'Atualize quando soltar',
    this.refreshingText: 'Atualizando...',
    this.completeText: 'Atualização terminou',
    this.noDataText: 'Sem mais dados',
    this.height: 60.0,
    this.noMoreIcon: const Icon(Icons.clear, color: Colors.grey),
    this.failedText: 'Atualização falhou',
    this.idleText: 'Deslize para atualizar',
